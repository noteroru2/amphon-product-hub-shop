...
const invariants = [
  ...
  [product.includes('USED PRODUCT TRUST'), 'used-product trust section'],
  [product.includes('SHOP3_RELATED_PRODUCTS'), 'related stock recovery'],
  [product.includes('ตำหนิที่แจ้งไว้'), 'defect disclosure'],
  [product.includes('การจัดส่งและการคืนสินค้า'), 'shipping return disclosure'],
