...
const SPEC_DETAILS: Array<{ key: string; section: string; name: string }> = [
  ...
  { key: 'inspection_date', section: 'Product evidence', name: 'Inspection date' },
  { key: 'inspection_result', section: 'Product evidence', name: 'Inspection result' },
  { key: 'basic_function_test', section: 'Product evidence', name: 'Basic function test' },
  { key: 'keyboard_test', section: 'Product evidence', name: 'Keyboard / trackpad test' },
  { key: 'ports_test', section: 'Product evidence', name: 'Ports test' },
  { key: 'wifi_bluetooth_test', section: 'Product evidence', name: 'Wi-Fi / Bluetooth test' },
  { key: 'webcam_mic_test', section: 'Product evidence', name: 'Webcam / microphone test' },
  { key: 'speaker_test', section: 'Product evidence', name: 'Speaker test' },
  { key: 'speaker_mic_test', section: 'Product evidence', name: 'Speaker / microphone test' },
  { key: 'storage_health', section: 'Product evidence', name: 'Storage health' },
  { key: 'stress_test', section: 'Product evidence', name: 'Stress test' },
  { key: 'gpu_stress_test', section: 'Product evidence', name: 'GPU stress test' },
  { key: 'temperature_test', section: 'Product evidence', name: 'Test temperature' },
  { key: 'charging_test', section: 'Product evidence', name: 'Charging test' },
  { key: 'camera_test', section: 'Product evidence', name: 'Camera test' },
  { key: 'button_test', section: 'Product evidence', name: 'Buttons test' },
  { key: 'autofocus_test', section: 'Product evidence', name: 'Autofocus test' },
  { key: 'video_test', section: 'Product evidence', name: 'Video recording test' },
  { key: 'card_slot_test', section: 'Product evidence', name: 'Memory card slot test' },
  { key: 'input_port_test', section: 'Product evidence', name: 'Display input test' },
  { key: 'burn_in_test', section: 'Product evidence', name: 'Burn-in test' },
  { key: 'network_test', section: 'Product evidence', name: 'Network test' },
  { key: 'controller_test', section: 'Product evidence', name: 'Controller test' },
  { key: 'benchmark_test', section: 'Product evidence', name: 'Benchmark / burn-in test' },
]
