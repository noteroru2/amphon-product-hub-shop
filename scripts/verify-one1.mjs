...
assert(flow.flowVersion === 'ONE-0R.1', 'product flow must match revised architecture')
...
console.log('AMPHON ONE-1 FOUNDATION: PASS — Hub bridge contract accepts System-first intake identity')
